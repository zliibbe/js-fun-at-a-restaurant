...
var vegetables = ["carrot", "sweet potatoes", "turnip", "kale", "onion"]
...
// different fruits.
var fruits = ["apple", "banana", "kiwi", "orange", "lemon", "lime", "clementine"];
...
var groceryStore = {
  name: "King Soopers",
  isOpen: true,
  address: "Unitah Ave & 19th Street",
  parkingSpots: 80,
  sellsLiquor: true,
}
...
groceryStore.cityLocation = "Denver, Colorado";

console.log(groceryStore.cityLocation);
